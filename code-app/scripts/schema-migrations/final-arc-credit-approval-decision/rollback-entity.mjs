#!/usr/bin/env node
// Rolls back the cr664_creditapprovaldecision table by deleting the ENTIRE
...
// writes to this table until then. If real decisions have already been
// recorded, export them first: deleting the entity deletes that data
// permanently.
//

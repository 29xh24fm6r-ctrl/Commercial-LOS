#!/usr/bin/env node
// Rolls back the PR 106 risk-rating columns by deleting each attribute.
// Safe at any point before RISK_RATING_PERSISTENCE_ENABLED is flipped to
// true -- no live code reads or writes these columns until then.
//

#!/usr/bin/env node
// Rolls back the PR 142 (N-17) governed test/production classification column by deleting the
// attribute. Safe at any point -- src/shared/deals/testDealClassification.ts's isTestOrSmokeDeal()
// falls back to the pre-existing name-convention match whenever this column is absent/unset, so no
// live behavior depends on the column existing.
//

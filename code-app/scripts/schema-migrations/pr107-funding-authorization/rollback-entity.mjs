#!/usr/bin/env node
// Rolls back the cr664_fundingauthorization table by deleting the ENTIRE
// entity (all its columns and any rows go with it). Safe at any point
// before FUNDING_AUTHORIZATION_ENABLED is flipped to true AND a live
// persistence adapter is wired -- no live code writes to this table until
// then. If real requests/approvals have already been recorded, export them
// first: deleting the entity deletes that data permanently.
//

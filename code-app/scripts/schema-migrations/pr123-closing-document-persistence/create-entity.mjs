#!/usr/bin/env node
// Creates the cr664_closingdocumentmanifest table (if absent) and its
// columns (idempotently). Two-phase: create the entity first (if missing),
// then create each attribute (skipping any that already exist).
//

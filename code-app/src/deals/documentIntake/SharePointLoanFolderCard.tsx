...
export function SharePointLoanFolderCard({ status, folder, canCreate, onCreate, onRetry }: { readonly status: DealFolderStatus; readonly folder?: DealSharePointFolderIdentity; readonly canCreate: boolean; readonly onCreate?: () => void; readonly onRetry?: () => void }) {

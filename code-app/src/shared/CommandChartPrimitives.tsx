 ...
 *
 * Originally landed in the manager role (Phase 124E / 125A) for the
 * dense Bloomberg Command Center. Phase 127A relocates the file to
 * the shared role so the Team Ops Queue (which the Phase 48 isolation
 * rule prevents from importing role-specific manager modules) and the
 * Portfolio cockpit can reuse the same vocabulary. The manager-side
 * file now re-exports from this module so every existing import path

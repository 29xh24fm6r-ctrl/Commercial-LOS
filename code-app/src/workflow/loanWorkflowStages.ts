...
export const LOAN_WORKFLOW_STAGES: readonly LoanWorkflowStageDefinition[] =
  Object.freeze([
    ...
    },
    {
      ...
      exitCriteria: ['Underwriting review is complete enough to record a recommendation.'],
      requiredFields: [
        ...identityFields,
      ...
      blockerRules: ['Open underwriting tasks or missing package-review evidence block credit readiness.'],
    },
    {
      id: 'credit_memo',
      label: 'Credit memo',
      entryCriteria: ['Completed credit memo package is ready for review.'],
      exitCriteria: ['Credit memo and required memo sections are present for review.'],
      requiredFields: identityFields,
      requiredDocuments: [],
      requiredTasks: [{ id: 'credit memo package review', label: 'Credit memo package review', type: 'task' }],
      creditRequirements: [

 ...
 */
export const Cr664_dealstagereferencesstatecode = {
  0: 'Active',
  1: 'Inactive'
} as const;
export type Cr664_dealstagereferencesstatecode = keyof typeof Cr664_dealstagereferencesstatecode;
export const Cr664_dealstagereferencesstatuscode = {
  1: 'Active',
  2: 'Inactive'
} as const;
...
export interface Cr664_dealstagereferencesBase {
  ...
  ownerid: string;
  owneridtype: string;
  statecode: Cr664_dealstagereferencesstatecode;
  statuscode?: Cr664_dealstagereferencesstatuscode;
  timezoneruleversionnumber?: number;
  utcconversiontimezonecode?: number;
}

export interface Cr664_dealstagereferences extends Cr664_dealstagereferencesBase {

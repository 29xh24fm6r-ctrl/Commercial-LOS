...
| `NOT_WIRED` | **14** entries | Includes Phase 160 classification of blocked `new-deal-create`; +2 from PR 105 (`origination-loan-structure-fields`, `financial-spread-persistence`); +1 from PR 106 (`risk-rating-persistence`); +2 from PR 107 (`closing-document-persistence`, `funding-authorization-persistence`) — all schema-pending, see docs/factory-arc/PR105_LOAN_STRUCTURE_SCHEMA_MIGRATION.md, docs/factory-arc/PR106_RISK_RATING_SCHEMA_MIGRATION.md, docs/factory-arc/PR107_CLOSING_FUNDING_ACTIVATION.md |

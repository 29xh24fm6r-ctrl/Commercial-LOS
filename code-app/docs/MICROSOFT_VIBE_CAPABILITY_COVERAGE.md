...
- **Build now / later / deferred.** Phase 76 closed the in-repo derivation slice; Phase 97 extended its reuse to the Teams deal-summary handoff; Phase 100 added a per-client Teams handoff on the Phase 76 card itself. Further extensions (notes capture, contact-history, AI briefs) are later.
